...
public abstract class picBaseFragment extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recognitionTextView = getView().findViewById(R.id.detected_item);
        recognitionValueTextView = getView().findViewById(R.id.detected_item_value);
        recognition1TextView = getView().findViewById(R.id.detected_item1);
        recognition1ValueTextView = getView().findViewById(R.id.detected_item1_value);
        recognition2TextView = getView().findViewById(R.id.detected_item2);
        recognition2ValueTextView = getView().findViewById(R.id.detected_item2_value);
